...
# Config definition
# -----------------------------------------------------------------------------
from configs.constants import PROJECT_PATH
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = os.path.join(PROJECT_PATH, "output")

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "paths_catalog.py")
_C.TENSORBOARD_EXPERIMENT = os.path.join(PROJECT_PATH, "log")
...
_C.DIC_FILE = os.path.join(PROJECT_PATH, 'tools', 'dic_coco.npy')

# The pre-prepared dictionary file path for intervention (numpy format)
_C.FEATURE_SAVE_PATH = os.path.join(PROJECT_PATH, 'tools', 'vc_feature')

# The prior probability P(z)
_C.PRIOR_PROB = os.path.join(PROJECT_PATH, 'tools', 'stat_prob.npy')
