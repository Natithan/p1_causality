...
LMDB_PATHS = [f"/cw/working-gimli/nathan/features_CoCa_lmdb/full_coca_36_{i}_of_4.lmdb" for i in range(4)]
MODEL_CKPT_DIR = "/cw/working-gimli/nathan/devlbert_ckpts"
